import svgPaths from "./svg-hbtn3cqmqc";
import imgPtDailyPromo101 from "figma:asset/c40c4f4e209437a007039a6d36e30c055e0959d0.png";
import imgPtDailyPromo102 from "figma:asset/f10df88a7dca2b1b76d5f9750c38136ffa2e7128.png";
...
function Frame22() {
  return (
    <div className="absolute content-stretch flex flex-col items-start left-[292px] top-[180px]">
      <Frame28 />
    </div>
  );
}
...
function TdsIcChevronUp() {
  return (
    <div className="relative shrink-0 size-[16px]" data-name="tds_ic_chevron_up">
      <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 16 16">
        <g id="tds_ic_chevron_up">
          <path d={svgPaths.p1f544f00} fill="var(--fill-0, #007BFF)" id="vector" />
        </g>
      </svg>
    </div>
  );
...
function Action1() {
  return (
    <div className="bg-[#e7f2ff] content-stretch flex gap-[4px] items-center justify-center px-[12px] py-[8px] relative rounded-[18px] shrink-0" data-name="Action">
      <div aria-hidden="true" className="absolute border border-[#007bff] border-solid inset-0 pointer-events-none rounded-[18px]" />
      <p className="font-['Tiket_Odyssey_Text:Regular',sans-serif] leading-[22px] not-italic relative shrink-0 text-[#007bff] text-[16px] text-nowrap">All Product</p>
      <TdsIcChevronUp />
    </div>
  );
}
...
function Filter() {
  return (
    <div className="absolute content-stretch flex gap-[254px] items-start left-0 top-0" data-name="Filter">
      <Left />
    </div>
  );
}
...
function DropdownFilter() {
  return (
    <div className="absolute content-stretch flex flex-col items-start left-[104px] top-[42px] w-[257px]" data-name="Dropdown Filter">
...
function Filter1() {
  return (
    <div className="absolute h-[38px] left-[292px] top-[124px] w-[692px]" data-name="Filter">
      <Filter />
      <DropdownFilter />
    </div>
  );
...
export default function BannersSelecting() {
  return (
    <div className="bg-[#f8f9fd] relative size-full" data-name="Banners - Selecting">
      <Details />
      <Title />
      <Frame22 />
      <Filter1 />
