function Frame() {
  return (
    <div className="bg-white content-stretch flex items-start px-[12px] py-[10px] relative rounded-[6px] shadow-[0px_2px_8px_0px_rgba(48,49,53,0.16)] shrink-0">
      <p className="font-['Tiket_Odyssey_Text:Bold',sans-serif] leading-[20px] not-italic relative shrink-0 text-[#007bff] text-[14px] text-nowrap">Option 1</p>
    </div>
  );
}
...
function Frame1() {
  return (
    <div className="bg-[#f4f7fe] content-stretch flex items-start px-[12px] py-[10px] relative rounded-[6px] shrink-0">
      <p className="font-['Tiket_Odyssey_Text:Bold',sans-serif] leading-[20px] not-italic relative shrink-0 text-[#71747d] text-[14px] text-nowrap">Option 2</p>
    </div>
  );
}
