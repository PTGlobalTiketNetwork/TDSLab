import svgPaths from "./svg-e0httmrvz9";
...
import { imgGroup415 } from "./svg-ior6y";
...
function TdsIcDownload() {
  return (
    <div className="absolute left-[8px] size-[24px] top-[8px]" data-name="tds_ic_download">
...
function Beak() {
  return (
    <div className="h-[8px] relative w-[16px]" data-name="Beak">
      <div className="absolute inset-[-0.03%_-12.5%_0_-12.5%]">
        <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 20 8.00207">
          <g id="Beak">
            <path d={svgPaths.p3d97b000} fill="var(--fill-0, #303135)" id="Tail" />
          </g>
        </svg>
      </div>
    </div>
...
function Text1() {
  return (
    <div className="bg-[#303135] relative rounded-[8px] shrink-0 w-full" data-name="Text">
      <div className="flex flex-row items-center overflow-clip rounded-[inherit] size-full">
        <div className="content-stretch flex items-center p-[12px] relative w-full">
          <p className="basis-0 font-['Tiket_Odyssey_Text:Regular',sans-serif] grow leading-[20px] min-h-px min-w-px not-italic relative shrink-0 text-[14px] text-white">Download</p>
        </div>
      </div>
    </div>
  );
...
function Vertical() {
  return (
    <div className="basis-0 content-stretch flex flex-col grow items-center min-h-px min-w-px relative rounded-[8px] shrink-0" data-name="Vertical">
...
function Tooltip() {
  return (
    <div className="absolute content-stretch flex items-start left-[-27px] top-[44px] w-[92px]" data-name="Tooltip">
      <Vertical />
    </div>
  );
}
...
function Download() {
  return (
    <div className="[grid-area:1_/_1] bg-[#f4f7fe] ml-[206px] mt-[93px] relative rounded-[20px] size-[40px]" data-name="Download">
      <TdsIcDownload />
      <Tooltip />
    </div>
  );
...
function CursorArrow() {
  return (
    <div className="[grid-area:1_/_1] ml-[225px] mt-[113px] relative size-[28px]" data-name="Cursor/Arrow">
...
export default function CreateNewBannerCompleteHover3Sec() {
  return (
    <div className="bg-[#f8f9fd] relative size-full" data-name="Create New Banner - Complete - Hover (3sec)">
      <WithMenu />
      <Frame3 />
    </div>
  );
