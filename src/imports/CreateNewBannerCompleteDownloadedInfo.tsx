import svgPaths from "./svg-s1w201a1a8";
...
import { imgGroup415 } from "./svg-tizds";
...
function Download() {
  return (
    <div className="[grid-area:1_/_1] bg-[#e7f2ff] content-stretch flex items-start ml-[206px] mt-[93px] p-[8px] relative rounded-[20px]" data-name="Download">
      <TdsIcDownload />
    </div>
  );
}
...
function CursorArrow() {
  return (
    <div className="[grid-area:1_/_1] ml-[226px] mt-[119px] relative size-[28px]" data-name="Cursor/Arrow">
...
function SnackbarGeneral() {
  return (
    <div className="absolute bg-[#303135] content-stretch flex gap-[8px] items-center left-[480px] px-[16px] py-[14px] rounded-[8px] top-[540px] w-[480px]" data-name="Snackbar - General">
      <p className="basis-0 font-['Tiket_Odyssey_Text:Regular',sans-serif] grow leading-[22px] min-h-px min-w-px not-italic relative shrink-0 text-[16px] text-white">OTW Hotel Promo - ID Translation has been downloaded.</p>
    </div>
  );
}

export default function CreateNewBannerCompleteDownloadedInfo() {
  return (
    <div className="bg-[#f8f9fd] relative size-full" data-name="Create New Banner - Complete - Downloaded info">
      <WithMenu />
      <Frame3 />
      <SnackbarGeneral />
    </div>
