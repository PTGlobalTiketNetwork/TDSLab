...
import { imgPlaceholder1X1NoBackground1461, imgPlaceholder1X1NoBackground1463 } from "./svg-emx0g";
...
function Frame() {
  return (
    <div className="[word-break:break-word] content-stretch flex flex-col font-['Tiket_Odyssey_Display:Bold',sans-serif] items-start leading-[0] not-italic relative shrink-0 text-[40px]">
      <div className="flex flex-col justify-center relative shrink-0 text-[#fedd00] w-full" style={{ fontFeatureSettings: '"dlig" 1' }}>
        <p className="leading-[36px]">Diskon</p>
      </div>
      <div className="flex flex-col justify-center relative shrink-0 text-white w-full" style={{ fontFeatureSettings: '"dlig" 1' }}>
...
export default function Component2Benefit() {
  return (
    <div className="content-stretch flex gap-[8px] items-center justify-center relative size-full" data-name="2 Benefit">
      <Frame />
      <Frame1 />
    </div>
  );
